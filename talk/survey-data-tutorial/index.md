...
author:
  ...
  - Isabella Velásquez
date: 2025-08-08
description: An interactive tutorial on analyzing weighted survey data in R using tidyverse workflows and survey design methods.
image: "thumbnail.jpeg"
image-alt: "Complex Survey Data Analysis: A Tidy Introduction with {srvyr} and {survey}"
format:
  html:
    css: /talk/talks.css
language: 
...
<ul style="list-style-type: none; padding-left: 0;">
  <li>👥 [useR! 2025](https://user2025.r-project.org/)</li>
  <li>📆 08 August 2025 // 01:00 PM ET</li>
  <li>💙️ Duke University</li>
</ul>
