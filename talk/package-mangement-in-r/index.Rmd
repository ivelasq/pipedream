...
| **Detail**     | **Information**                                                                                                                                                                                                                                   |
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Abstract**   | Reproducible data science encompasses practices like version control, literate programming, and proper management of packages. This webinar discusses solutions for maintaining R packages when upgrading to a new R version and using the `renv` package. |
| **Date**       | 07 May 2020                                                                                                                                                                                                                                        |
| **Time**       | 12:00 PM PT                                                                                                                                                                                                                                        |
| **Location**   | Remote                                                                                                                                                                                                                                             |
