...
author:
  ...
  - Isabella Velásquez
date: "2020-05-07"
description: A webinar on reproducible data science in R, focusing on managing packages and using renv for version control.
image: "thumbnail.png"
image-alt: "Package Management for Reproducible Data Science in R"
format:
  html:
    css: /talk/talks.css
language: 
...
```{=html}
<a href="https://www.meetup.com/Seattle-useR/events/270353523/" class="btn btn-secondary">
  <i class="bi bi-calendar-event"></i>&nbsp;&nbsp;Event
</a>

<a href="https://garciamikep.github.io/useR-webinar/useR-slides.html#1" class="btn btn-secondary" target="_blank" rel="noopener noreferrer">
  <i class="bi bi-tv"></i>&nbsp;&nbsp;Slides
</a>

<a href="https://github.com/garciamikep/useR-webinar" class="btn btn-secondary" target="_blank" rel="noopener noreferrer">
...
<ul style="list-style-type: none; padding-left: 0;">
  <li>👥 [Seattle useR Group](https://www.meetup.com/Seattle-useR/events/270353523/)</li>
  <li>📆 07 May 2020 // 12:00 PM PT</li>
  <li>💻️ Virtual</li>
</ul>

## Description

Reproducible data science encompasses practices like version control, literate programming, and proper management of packages. This webinar discusses solutions for maintaining R packages when upgrading to a new R version and using the {renv} package.

## Slides

<iframe src="https://garciamikep.github.io/useR-webinar/useR-slides.html#1" height="415" width="800" ></iframe>
...
Then, the script determines which of your versions is the newest, current version of R and which was the second newest version of R and calls them new_r and old_r.
Then, it finds the library paths, or .libPaths(), for new_r and old_r and extracts the list of packages that are available in old_r.

Then, it creates a function called install_all that installs packages.
