...
![Import, tidy, visualize, transform, model, communicate but having to redo several components](https://ivelasq.rbind.io/images/target-files/2.png)
...
![A groundhog next to a series of code sourcing data from other files](https://ivelasq.rbind.io/images/target-files/3.png)
...
![Clinical trial experiment with corresponding functions](https://ivelasq.rbind.io/images/target-files/5.png)
...
![Example target file with annotations for the requirements](https://ivelasq.rbind.io/images/target-files/6.png)
...
![Example file structure](https://ivelasq.rbind.io/images/target-files/7.png)
...
![Example dependency chart](https://ivelasq.rbind.io/images/target-files/7.png)
...
![Example dependency chart with outdated notes](https://ivelasq.rbind.io/images/target-files9.png)
