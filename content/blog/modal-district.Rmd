...
My good friend [Ryan Estrellado](https://twitter.com/RyanEs) recommended an [NRP Planet Money podcast episode](https://www.npr.org/2019/08/28/755191639/episode-936-the-modal-american) on the "Modal American." Working with Ben Casselman, they explored the most 'typical' American. It was a fantastic, engaging episode about a common statistical technique that I've never seen applied in this way before. They ran the numbers on a variety of demographic variables to see what group made up of the combination of those variables is the most common in the U.S. (I highly recommend the episode - it's pretty surprising!).
...
What buckets do you choose for analysis? This is a bit tricky. I chose buckets I typically refer to for work. I also referred to [NCES reports](https://nces.ed.gov/pubs2011/2011301.pdf) to see how they typically think about districts. Ultimately, I decided on four buckets: urban-centric locale bucket, race/ethnicity bucket, size bucket, and FRPL bucket.
...
Here, we borrow from Planet Money's analysis to use the `grouper()` function. 
...
I tried to visualize them another way - using bar plots. Again, this gets a bit unruly with all the variables but we can quickly see there are very few Large districts, regardless of urbanicity.
