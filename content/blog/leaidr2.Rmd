...
![](https://ivelasq.rbind.io/img/mapbox_files/1.png)
...
![](https://ivelasq.rbind.io/img/mapbox_files/3.png)
...
![](https://ivelasq.rbind.io/img/mapbox_files/4.png)
...
So, if you were to install and load {leaidr}, you can run `leaidr::runExample()` to launch the Shiny app. To see what the files look like, check out the Github repo [here](https://github.com/ivelasq/leaidr).
