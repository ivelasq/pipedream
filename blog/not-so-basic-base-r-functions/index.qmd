...
::: {.callout-note}
This post includes functions from the [base](https://stat.ethz.ch/R-manual/R-devel/library/base/html/00Index.html), [graphics](https://stat.ethz.ch/R-manual/R-devel/library/graphics/html/00Index.html), and [stats](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/00Index.html) packages, which are imported when you open up R. Other packages are grDevices, utils, datasets, and methods.[^packages]
:::
...
I have written about nzchar [in the past](https://ivelasq.rbind.io/til/asciicast/) - also included how to create a GIF with [asciicast](https://github.com/r-lib/asciicast)!
...
If you're a base R user, you are probably aware of the dollar signs `$` that you need to use to evaluate expressions with variables from a data frame. The `with()` function, you can reference columns directly without having to rewrite the data frame name multiple times, making your code more concise and easier to read.
...
[Michael Love's Tweet](https://twitter.com/mikelove/status/1197190835994943489) shows how to connect a dplyr chain to a base plot function:
...
* [Maëlle Salmon's blog](https://masalmon.eu/tags/useful-functions/)
* [Neil Wright's post](https://www.neilwright.uk/posts/five-r-functions)
* [Yihui Xie's list](https://yihui.org/en/2023/10/three-functions/)! 
...
Thank you to the community members sharing their favorite functions and code walkthroughs!

[^longnote]: Many thanks to the following resources for making this post possible:

    - webR and the [webR documentation](https://docs.r-wasm.org/webr/latest/) by George Stagg.
