...
When writing a function, R can print a lot of stuff implictly. Using `invisible()`, you can return results while controlling what is displayed to a user, avoiding cluttering the console with intermediate results.
