...
::: {.callout-note}
I accidentally had seven functions in my post, even though it's titled "Six not-so-basic base R functions." Oops! Consider the null-coalescing operator as a bonus, as it's not part of base R yet. 😊
:::
