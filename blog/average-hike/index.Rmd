...
date: "2019-04-06"
description: "Analyzing hiking data from GPX files."
image: thumbnail.jpg
---

![Vincent Van Gogh, Olive Trees with the Alpilles in the Background)](thumbnail-wide.jpg)
...
![Joyplot showing trail distance and height](joyplot.png)
...
![line chart showing distance and elevation of individual hikes with a darker line highlighting the average elevation by distance](avg_hike.png)
...
![Scatterplot of total distance by total elevation](tot_dis_elev.png) 
...
![Cluster analysis of hikes by elevation and distance](cluster_analysis.png)
...
![Histogram of hike total distance](dist_histogram.png)
...
![Cumulative bar plot of distance](cum_dist.png)
...
![Histogram of hike total elevation](elev_histogram.png)
...
![Cumulative bar plot of elevation](cum_elev.png)
