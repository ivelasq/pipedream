---
title: "Using flexdashboard and GitHub Actions to create an automated YouTube dashboard"
categories: ["tutorial"]
date: today
description: "Interested in a custom feed of YouTube videos? Here's how to create an automated dashboard with flexdashboard and GitHub Actions."
...
If you made it all the way to the end of this tutorial, I need to plug (as an employee of Posit, formerly RStudio 😁): [Posit Connect!](https://posit.co/products/enterprise/connect/). Posit Connect is a platform that allows you to publish and share data products like Quarto docs, Shiny apps, and -- you guessed it -- flexdashboards!
