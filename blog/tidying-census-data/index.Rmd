...
image: thumbnail.jpg
description: Census data is valuable, but stored in Excel spreadsheets. 
---

![Hendrick Avercamp, Ice-skating in a Village (1610)](thumbnail-wide.jpg)
...
![One of the Census Excel spreadsheets pointing out egregious formatting, like headers, merged cells, and categories in rows.](census_image.png)
...
![First three columns of the imported dataset](census1.png)
...
![Dataset with skipped lines](census2.png)
...
![Dataset with cleaned names](census3.png)
...
![Dataset with removed rows](census4.png)
...
![Dataset with filtered rows](census5.png)
...
![Viewing the list](census_list.png)
