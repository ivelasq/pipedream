---
title: "How to find out how much of Core R is R"
date: "2024-12-25"
category: R
...
Now, we can visualize the percentage of Core R sourcecode files by language using ggplot2:
...
r_loc |> 
  ...
  theme_minimal() +
  labs(title = "Percentage of Core R Sourcecode Files by Language") +
...
Or, we can visualize the percentage of Core R lines of code by language:
...
r_loc |> 
  ...
  theme_minimal() +
  labs(title = "Percentage of Core R Lines of Code by Language") +
  theme(plot.title = element_text(size = 14),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        axis.text.x = element_text(size = 12),
